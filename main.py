...
model.maximize(1.40 * p1 + 1.50 * p2 + 2.30 * p3 + 2.10 * p4 + \
               1.90 * p5 + 3.50 * p6 + 2.20 * p7 + 2.70 * p8 + 4.15 * p9 + \
               2.00 * p10 + 1.90 * p11 + 1.10 * p12 + 1.10 * p13 + 2.15 * p14 + \
               1.00 * p15 + 1.70 * p16 + 1.80 * p17 + 9.75 * p18 + 9.10 * p19 + 12.40 * p20 + \
               10.90 * p21 + 13.20 * p22 + 17.50 * p23 + 8.50 * p24 + \
               6.50 * p25 + 3.60 * p26 + 10.65 * p27 + 4.75 * p28 + 6.00 * p29 + \
               3.10 * p30 + 7.35 * p31 + 2.40 * p32 + 1.30 * p33 + 0.70 * p34 + \
               2.30 * p35 + 1.70 * p36 + 5.35 * p37 + 0.65 * p38 + 1.10 * p39 + 1.30 * p40 - \
